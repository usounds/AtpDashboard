...
--
-- Name: event_logs_summary; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.event_logs_summary AS
 ...
 SELECT count(DISTINCT el.creator_did) AS total_creators,
    count(DISTINCT el.server_did) AS total_servers,
    count(DISTINCT ((el.creator_did || ':'::text) || el.rkey)) AS total_creator_rkeys,
