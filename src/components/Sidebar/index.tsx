        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/' || pathname.includes('/collection/browser')
                }
                defaultOpen={true}
              >
                {(handleClick, open) => {
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname.startsWith('/customfeed/')
                }
                defaultOpen={true}
              >
                {(handleClick, open) => {
          ...
          <div className="flex gap-6 flex-wrap items-center justify-center ">
            <div className="text-center">
              <a
                href="https://github.com/usounds/AtpDashboard"
                target="_blank"
